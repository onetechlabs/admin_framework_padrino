# -*- encoding: utf-8 -*-
# stub: padrino-gen 0.14.4 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<padrino-helpers>.freeze, ["= 0.14.4"])
    s.add_development_dependency(%q<padrino-mailer>.freeze, ["= 0.14.4"])
  else
